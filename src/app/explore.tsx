        ...
        <ThemedView style={styles.sectionsWrapper}>
          <Collapsible title="File-based routing">
            <ThemedText type="small">
              Este app possui duas telas: <ThemedText type="code">src/app/index.tsx</ThemedText> and{' '}
          ...
          <Collapsible title="Light and dark mode components">
            <ThemedText type="small">
              Esse template suporta o tema claro e escuro. O{' '}
              <ThemedText type="code">useColorScheme()</ThemedText> hook  auxiliará a inspecionar qual é o tema selecionado,
              cores configuradas, e você também poderá ajustar a UI (User Interface), Interface do Usuário
          ...
          <Collapsible title="Animations">
            <ThemedText type="small">
              Este template inclui um exemplo de componente de animação . The{' '}
              <ThemedText type="code">src/components/ui/collapsible.tsx</ThemedText> componente usa um poderoso recurso
              the powerful <ThemedText type="code">react-native-reanimated</ThemedText> para animar
              a abertura dessa dica
            </ThemedText>
          </Collapsible>
        </ThemedView>
